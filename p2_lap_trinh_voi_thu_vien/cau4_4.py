...
def main():
    ...
    ax1.plot_surface(x,y,z1,cmap= 'winter_r',linewidth=0, antialiased=False)
    ax2.plot_surface(x2,y2,z2,cmap= 'bwr',linewidth=0, antialiased=False)
    ax2.plot_surface(x2, y2, z22,cmap= 'bwr',linewidth=0, antialiased=False)
    ax3.plot_surface(x3,y3,z3,cmap= 'viridis_r',linewidth=0, antialiased=False)
    ax3.plot_surface(x3, y3, z33,cmap= 'viridis_r',linewidth=0, antialiased=False)
    plt.show()
